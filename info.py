...
API_ID = int(environ.get('API_ID', '21009296'))
API_HASH = environ.get('API_HASH', '0037baad542f2a050bce0bb8532b8c1f')
...
# Admins & Users
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '5757126789 7592041488').split()] # For Multiple Id Use One Space Between Each.
...
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1002520619080'))

# This Is File Channel Where You Upload Your File Then Bot Automatically Save It In Database 
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002506366082').split()]  # For Multiple Id Use One Space Between Each.
...
auth_channel = environ.get('AUTH_CHANNEL', '-1002127561274') # give your force subscribe channel id here else leave it blank
AUTH_CHANNEL = int(auth_channel) if auth_channel and id_pattern.search(auth_channel) else None

# This Channel Is For When User Request Any File Name With command or hashtag like - /request or #request
reqst_channel = environ.get('REQST_CHANNEL', '-1002127561274')
...
# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://ubharathu5:Bharath57@cluster0.vf3vmwv.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")   # IF Multiple Database Is False Then Fill Only This Database Url.
...
# Links
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/+DXyWSYM3dTA3ODE1')
CHNL_LNK = environ.get('CHNL_LNK', 'https://t.me/+Tq4hE7VLg8o1YjE1')
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', '+Tq4hE7VLg8o1YjE1') # Support Chat Link Without https:// or @
OWNER_LNK = environ.get('OWNER_LNK', 'https://t.me/NsRedEye_Links_contacbot')
...
SHORTLINK_API = environ.get('SHORTLINK_API', '2e4ffe3b84d4958b41ec436f1d8499eeb673652e')
TUTORIAL = environ.get('TUTORIAL', 'https://t.me/+I4HSPm7DYZNkNDM1') # How Open Shortner Link Video Link , Channel Link Where You Upload Your Video.
